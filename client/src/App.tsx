...
import { AnalyticsAuthObserver } from "./components/AnalyticsAuthObserver";
...
export default function App() { return <ErrorBoundary><ThemeProvider><EntitlementProvider><AnalyticsAuthObserver /><Router /></EntitlementProvider></ThemeProvider></ErrorBoundary>; }
